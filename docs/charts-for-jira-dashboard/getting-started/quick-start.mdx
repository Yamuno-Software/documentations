...
1. Explore [Features & How To](/docs/charts-for-jira-dashboard/how-to-and-features)
2. Learn about [Chart Types](/docs/charts-for-jira-dashboard/how-to-and-features/chart-types)
3. Check [Known Issues](/docs/charts-for-jira-dashboard/known-issues) for troubleshooting
4. Review [Release Notes](/docs/charts-for-jira-dashboard/release-notes) for latest updates
