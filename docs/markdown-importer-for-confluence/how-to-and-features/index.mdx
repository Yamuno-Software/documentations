...
- **[Importing Markdown](/docs/markdown-importer-for-confluence/how-to-and-features/importing-markdown)**: Convert markdown files to Confluence pages
- **[Export Features](/docs/markdown-importer-for-confluence/how-to-and-features/export-pages)**: Convert Confluence pages to markdown files
...
For detailed import instructions, see the [Importing Markdown to Confluence](/docs/markdown-importer-for-confluence/how-to-and-features/importing-markdown) guide.
...
1. Check the [Known Issues](/docs/markdown-importer-for-confluence/known-issues) page
