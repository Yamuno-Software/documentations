...
Yes! The API is perfect for CI/CD integration. Check out our [GitHub Actions](/markdown-importer-for-confluence/rest-api/examples#github-actions) and [GitLab CI/CD](/markdown-importer-for-confluence/rest-api/examples#gitlab-cicd) examples.
...
You can make multiple API calls sequentially or in parallel (with rate limiting). See our [batch import examples](/markdown-importer-for-confluence/rest-api/examples#batch-import).
...
See [Troubleshooting: Unauthorized](/markdown-importer-for-confluence/rest-api/troubleshooting#issue-unauthorized-error-401) for solutions.
...
See [API Reference: Finding IDs](/markdown-importer-for-confluence/rest-api/api-reference#finding-space-and-page-ids) for more details.
...
Check our [release notes](/markdown-importer-for-confluence/release-notes) for recently added features and upcoming improvements.
...
1. **Check Documentation:**
   - [Getting Started](/markdown-importer-for-confluence/rest-api/getting-started)
   - [API Reference](/markdown-importer-for-confluence/rest-api/api-reference)
   - [Troubleshooting](/markdown-importer-for-confluence/rest-api/troubleshooting)
   - [Examples](/markdown-importer-for-confluence/rest-api/examples)
